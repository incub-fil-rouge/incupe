    ...
    <div class="bg-white py-24 sm:py-32">
      <div class="mx-auto grid max-w-7xl gap-y-20 gap-x-8 px-6 lg:px-8 xl:grid-cols-3">
        <div class="max-w-2xl">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-600">Libero fames augue nisl porttitor nisi, quis. Id ac elit odio vitae elementum enim vitae ullamcorper suspendisse. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quis quam similique minima mollitia minus sunt earum dolores omnis dolor at eaque odio saepe nesciunt quas officiis, maiores velit? Dolor, tenetur?</p>
        </div>
