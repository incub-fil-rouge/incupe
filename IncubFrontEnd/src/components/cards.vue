<template>
  <section class="flex items-center justify-center flex-col  bg-yellow-50 ">
    ...
    <section class="h-auto w-screen py-6 flex items-center justify-center flex-wrap ">
...
<div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
  ...
  <div class="p-5">
    <a href="#">
      <h5 class="text-gray-900 font-bold text-2xl tracking-tight mb-2 dark:text-white">Noteworthy technology
